		...
		success:function(data){
			...
			$.each(data, function(key1, val1){
				...
				$.each(val1, function(key2, val2){
					...
					var div1 = $('<div class="card" style="width: 340px; height:330px; display:inline-block; float:left; margin-top:50px; margin-right:50px;" onclick="pReview_view_open(${number})"></div>');
					var div2 = $('<div class="card-body" style="width:340px; height:120px;"></div>');
